...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a href="{{ url('admin/pengeluaran/create') }}" class="btn btn-primary mb-3">
                    ...
                    <table class="table table-bordered datatable align-middle">
                        <thead class="bg-primary text-white">
                            <tr>
                                ...
                                <th width="38%" class="text-start">Detail Pengeluaran</th>
                                <th width="20%" class="text-start">Nominal</th>
